...
/**
 * Created by 142715R on 11/12/2015.
 */
@Entity
...
public class BooksEntity {
    ...
    @Basic
    @Column(name = "surname", nullable = true, insertable = true, updatable = true, length = 24)
    ...
    @Basic
    @Column(name = "first_name", nullable = true, insertable = true, updatable = true, length = 24)
    ...
    @Basic
    @Column(name = "title", nullable = true, insertable = true, updatable = true, length = 96)
    ...
    @Basic
    @Column(name = "onSale", nullable = true, insertable = true, updatable = true)
    ...
    @Basic
    @Column(name = "calendar_year", nullable = true, insertable = true, updatable = true)
    ...
    @Basic
    @Column(name = "inventory", nullable = true, insertable = true, updatable = true)
